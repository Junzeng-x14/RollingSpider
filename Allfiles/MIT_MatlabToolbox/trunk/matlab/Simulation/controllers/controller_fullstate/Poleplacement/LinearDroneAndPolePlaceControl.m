...
T = T1+T2+T3+T4;
tauy = 0.0024*T1-0.0024*T2+0.0024*T3-0.0024*T4;
taup = -0.0441*T1-0.0441*T2+0.0441*T3+0.0441*T4;
taur = -0.0441*T1+0.0441*T2+0.0441*T3-0.0441*T4;
%Inertia
J            = quad.J;
...
input_equil = inv(Ts2Q)*[-quad.g*quad.M ;0 ;0 ;0];                %u_eq
